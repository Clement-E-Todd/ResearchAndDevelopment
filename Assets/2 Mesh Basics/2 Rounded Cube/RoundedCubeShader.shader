Shader "Custom/RoundedCubeShader" {
    ...
    SubShader{
        ...
        CGPROGRAM
        // Tell the shader to create different versions of itself depending on which "faces" enum value was selected
        // One of the following keywords will be defined in each version
